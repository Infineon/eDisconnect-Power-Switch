...
<ResourceModel:App xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ResourceModel="http://www.infineon.com/Davex/Resource.ecore" name="PIN_INTERRUPT" URI="http://resources/4.0.4/app/PIN_INTERRUPT/0" description="The PIN_INTERRUPT APP invokes user interrupt handler in a response &#xA;to rising and/or falling edge event signal on a pin." mode="NOTSHARABLE" version="4.0.4" minDaveVersion="4.0.0" instanceLabel="PIN_INT_DRIVER" appLabel="">
  ...
  <virtualSignals name="iout" URI="http://resources/4.0.4/app/PIN_INTERRUPT/0/vs_pin_interrupt_iout" hwSignal="iout" hwResource="//@hwResources.3"/>
  ...
  <virtualSignals name="Pin_signal" URI="http://resources/4.0.4/app/PIN_INTERRUPT/0/__pin_vs_pin_interrupt_iopad" hwSignal="pin" hwResource="//@hwResources.4"/>
  <requiredApps URI="http://resources/4.0.4/app/PIN_INTERRUPT/0/appres_cpu" requiredAppName="CPU_CTRL_XMC1" requiringMode="SHARABLE">
  ...
  <hwResources name="Pin" URI="http://resources/4.0.4/app/PIN_INTERRUPT/0/__pin_hwres_port_pin" resourceGroupUri="devicepackage/0/25" constraintType="GLOBAL_RESOURCE" mResGrpUri="devicepackage/0/*">
  ...
  <connections URI="http://resources/4.0.4/app/PIN_INTERRUPT/0/http://resources/4.0.4/app/PIN_INTERRUPT/0/vs_pin_interrupt_iout/http://resources/4.0.4/app/PIN_INTERRUPT/0/vs_pin_interrupt_signal" systemDefined="true" sourceSignal="iout" targetSignal="sr_node" srcVirtualSignal="//@virtualSignals.4" targetVirtualSignal="//@virtualSignals.5"/>
