...
<ResourceModel:App xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ResourceModel="http://www.infineon.com/Davex/Resource.ecore" name="PWM" URI="http://resources/4.1.12/app/PWM/0" description="Generates a PWM using one timer slice of CCU4 or CCU8" mode="NOTSHARABLE" version="4.1.12" minDaveVersion="4.3.2" instanceLabel="PC_Ctrl" appLabel="" containingProxySignal="true">
  ...
  <virtualSignals name="event_period_match" URI="http://resources/4.1.12/app/PWM/0/vs_pwm_ccu8_cc8_slice_period_match_interrupt" hwSignal="pmus_omds" hwResource="//@hwResources.0" required="false" visible="true"/>
  ...
  <virtualSignals name="event_period_match" URI="http://resources/4.1.12/app/PWM/0/vs_pwm_ccu4_cc4_slice_period_match_interrupt" hwSignal="pmus_omds" hwResource="//@hwResources.1" visible="true"/>
  ...
  <hwResources name="PWM Output Pin" URI="http://resources/4.1.12/app/PWM/0/__pin_hwres_port_pad_pwm_out" resourceGroupUri="devicepackage/0/11" constraintType="GLOBAL_RESOURCE" mResGrpUri="devicepackage/0/*">
  ...
  <connections URI="http://resources/4.1.12/app/PWM/0/http://resources/4.1.12/app/PWM/0/vs_pwm_ccu4_cc4_slice_period_match_interrupt/http://resources/4.0.10/app/INTERRUPT/1/vs_nvic_signal_in" sourceSignal="event_period_match" targetSignal="sr_irq" srcVirtualSignal="//@virtualSignals.7">
